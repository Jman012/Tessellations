...
class TriangleUp: Shape {
    ...
    init(sideLength: CGFloat, pipeWidth: CGFloat) {
        ...
        var transformScale = CGAffineTransformMakeScale((height - margin*2) / height, (height - margin*2) / height)
        ...
        transformScale = CGAffineTransformMakeScale(1.0, (r - margin/1.5) / r)
